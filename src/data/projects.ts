const projects = [
  ...
  },
  {
    ...
    title: 'Easy Cooking',
    summary:
      'Projeto desenvolvido com a Gabriela Aguiar. O objetivo desse projeto é auxiliar as pessoas na hora de cozinhar. Você digita 3 ingredientes que você possui na sua geladeira, e o nosso site retorna receitas compatíveis com os ingredientes informados. É necessário criar uma conta para visualizar e cadastrar novas receitas.',
    tech: [
      'Javascript',
      'NodeJS',
      'MongoDB',
